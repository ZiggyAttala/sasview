...
def TEMP_TEST():
    ...
    test_invertor = Invertor()
    test_invertor.d_max = 2000
    print("\nTEMP TEST:")
    print("ERR: ", test_invertor.get_pr_err(np.arange(20, dtype = np.float64), np.ones((20,20), dtype = np.float64), np.float64(5.0)))
    print("d_max: ", test_invertor.d_max)
    print("\n***\n")
